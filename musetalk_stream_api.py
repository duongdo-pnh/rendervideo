...
AVATARS = {}
# RTX 3090 (24 GB) has sufficient headroom for 32 frames at once.  This changes
# throughput only: same MuseTalk model, precision, resolution and FPS.
MAX_GPU_BATCH = max(1, int(os.getenv("MUSETALK_MAX_GPU_BATCH", "32")))
